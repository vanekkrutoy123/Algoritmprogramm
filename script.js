...
// 6 Задача 
// С клавиатуры вводится слово программа должна проверить есть ли буква k в этом слове
// использовать include (a) 
// решить с тернарным оператором

// let word = prompt("напишите слово")
// let resultat = word.includes("к") ? "Буква 'к' есть" : "Буквы 'к' нет";
// alert (resultat)
// БЫЛА ОШИБКА В СИНАКСИСЕ "" ''

// 1 ЗАДАЧА 
// Пользователь вводит сумму покупки с клавиатуры, 
// если сумма покупки от 1000 до 2000 то скидка будет 10%
// если сумма покупки от 2000-5000 то скидка составит 15%
// если покупка составляет более 5000 тысяч то скидка 30% 
// если покупка меньше 1000 то без скидки
// решить задачу с помощью if, else. 

// let z = +prompt("Введите сумму покупки")
// if (z < 1000) {
...
// 2 ЗАДАЧА 
// Пользователь вводит число с клавиатуры от 1 до 7 
...
// 5 Задача (*) (взял у дена)
// Студент вводит с клавиатуры баллы по трём предметам 
// программа должна вывести результатом среднее арифметическое значение от 0 до 100 
// и вывести оценку 
// 90 - 100 баллов // 5
// 75 - 89 баллов // 4
// 60 - 74 баллов // 3 
...
// let a = +prompt ("введите балл за 1 предмет")
// let b = +prompt ("введите балл за 2 предмет")
// let c = +prompt ("введите балл за 3 предмет")
